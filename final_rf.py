...
class RainPredictionSystem:
    def __init__(self, credentials_path, spreadsheet_id, sheet_name):
        ...
        self.spreadsheet_id = '1JXxsLUMpwkubsGcZ1iGEQuKhQxvrLB92JehDwILTB_4'
...
SPREADSHEET_ID = '1JXxsLUMpwkubsGcZ1iGEQuKhQxvrLB92JehDwILTB_4'                        # 🔁 Replace with your actual Google Sheet ID
